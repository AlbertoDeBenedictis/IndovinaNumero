...
public class FXMLController {
	...
	void doNuova(ActionEvent event) {
		...
		// devo chiamare il metodo del modello
	...
	void doTentativo(ActionEvent event) {
		...
		try {
			...
			txtRisultato.appendText(ile.getMessage());
			return;
		...
		if (risultato == 0) {
			txtRisultato.appendText("Hai vinto!!!\n Hai vinto con " + this.model.getTentativiFatti() + " tentativi\n");
		} else if (risultato == -1) {
	...
	void initialize() {
		...
		// creare il model qui sarebbe piuttosto rischioso
	}
